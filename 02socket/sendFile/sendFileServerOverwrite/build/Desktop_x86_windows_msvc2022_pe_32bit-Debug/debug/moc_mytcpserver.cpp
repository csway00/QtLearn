...
QT_MOC_LITERAL(1, 12, 10), // "sendSocket"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 7), // "qintptr"
QT_MOC_LITERAL(4, 32, 4) // "sock"

    },
    "MyTcpServer\0sendSocket\0\0qintptr\0sock"
};
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendSocket((*reinterpret_cast< qintptr(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpServer::sendSocket)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpServer::sendSocket(qintptr _t1)
{
