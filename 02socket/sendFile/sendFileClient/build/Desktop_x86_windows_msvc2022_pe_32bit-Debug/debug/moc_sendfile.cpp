...
QT_MOC_LITERAL(1, 9, 11), // "connectedOK"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11), // "alreadyOver"
QT_MOC_LITERAL(4, 34, 15), // "sendProgressVal"
QT_MOC_LITERAL(5, 50, 3) // "num"

    },
    "SendFile\0connectedOK\0\0alreadyOver\0"
    "sendProgressVal\0num"
};
...
void SendFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->connectedOK(); break;
        case 1: _t->alreadyOver(); break;
        case 2: _t->sendProgressVal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::connectedOK)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SendFile::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::alreadyOver)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SendFile::sendProgressVal)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SendFile::connectedOK()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SendFile::alreadyOver()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void SendFile::sendProgressVal(int _t1)
{
