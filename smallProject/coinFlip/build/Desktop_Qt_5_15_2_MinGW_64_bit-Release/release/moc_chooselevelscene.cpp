...
QT_MOC_LITERAL(1, 17, 16), // "chooseSceneBack1"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "ChooseLevelScene\0chooseSceneBack1\0"
};
...
void ChooseLevelScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->chooseSceneBack1(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChooseLevelScene::chooseSceneBack1)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChooseLevelScene::chooseSceneBack1()
{
